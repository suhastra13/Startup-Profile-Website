...
<style>
    /* ============================================
       BLOG CREATE STYLES - CORAL THEME
    ============================================ */
                ...
                <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" id="blogForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="char-counter">
                            ...
                            <span>
                                <span class="char-counter-current" id="titleCounter">0</span> / 100
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="category-pills">
                                <div class="category-pill">
                                    <input type="radio" id="cat_tech" name="category" value="Technology" {{ old('category') == 'Technology' ? 'checked' : '' }}>
                                ...
                                <div class="category-pill">
                                    <input type="radio" id="cat_business" name="category" value="Business" {{ old('category') == 'Business' ? 'checked' : '' }}>
                                ...
                                <div class="category-pill">
                                    <input type="radio" id="cat_tutorial" name="category" value="Tutorial" {{ old('category') == 'Tutorial' ? 'checked' : '' }}>
                        ...
                        <div class="file-upload-wrapper">
                            ...
                            <div class="file-upload-preview" id="imagePreview">
                                <div style="padding: 2rem; text-align: center; color: var(--gray-500);">
                                    <i class="bi bi-image" style="font-size: 3rem; color: var(--gray-400); margin-bottom: 1rem;"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="char-counter">
                            ...
                            <span>
                                <span class="char-counter-current" id="excerptCounter">0</span> / 300
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="switch-wrapper">
                            ...
                            <div class="switch-label">
                                ...
                                <div class="switch-label-desc">Make this post visible to public immediately after saving</div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    // Sync custom category to hidden input on form submit
    document.getElementById('blogForm').addEventListener('submit', function(e) {
        if (customCategoryRadio.checked) {
            const customValue = customCategoryInput.value.trim();
            if (customValue) {
                // Create a temporary input for custom category
    ...
    // Initialize counters
    if (titleInput.value) titleCounter.textContent = titleInput.value.length;
    if (excerptInput.value) excerptCounter.textContent = excerptInput.value.length;
</script>
@endsection