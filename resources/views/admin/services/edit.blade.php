...
<style>
    /* ============================================
       EDIT SERVICE STYLES - CORAL THEME
    ============================================ */
    ...
    .new-image-preview-container.active {
        display: block;
    }
    ...
    <div class="col-lg-10 col-xl-9">
        ...
        <div class="info-box">
            ...
            <p class="info-box-text">
                Update the service information below. Changes will be reflected immediately on your website once saved.
                Make sure to review all fields before updating.
            </p>
        </div>
        ...
        <div class="modern-card">
            <div class="modern-card-header">
                <h5>
                    ...
                    <span class="service-id-badge">ID: #{{ $service->id }}</span>
                </h5>
            </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="icon-picker-btn" id="iconPickerBtn">
                                    <div class="icon-picker-btn-content">
                                        <div class="icon-picker-btn-icon">
                                            <i class="{{ $service->icon ?: 'bi bi-stars' }}" id="selectedIconDisplay"></i>
                                        </div>
                                        <div class="icon-picker-btn-text">
                                            <span id="iconPickerBtnText">{{ $service->icon ? 'Change icon...' : 'Choose an icon...' }}</span>
                                        </div>
                                    </div>
                                ...
                                <!-- Icon Preview Box -->
                                <div class="icon-preview-box {{ $service->icon ? 'active' : '' }}" id="iconPreviewBox">
                                    <div class="icon-preview-large" id="iconPreviewLarge">
                                        <i class="{{ $service->icon ?: 'bi bi-stars' }}"></i>
                                    </div>
                                    <div class="icon-preview-label">Current Icon</div>
                                    <div class="icon-preview-name" id="iconPreviewName">{{ $service->icon ?: 'No icon selected' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="image-upload-wrapper">
                                    ...
                                    <div class="form-text">
                                        ...
                                        <span>Upload new image to replace current (800x600px, max 2MB)</span>
                                    </div>
                                    ...
                                    <!-- New Image Preview -->
                                    <div class="new-image-preview-container" id="newImagePreviewContainer">
                                        <div class="new-image-label">
                                            <i class="bi bi-stars"></i>
                                            New Image
                                        </div>
                                        <div class="position-relative d-inline-block">
                                            <img id="newImagePreview" src="" alt="Preview" class="new-image-preview">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3 form-check form-switch">
                            ...
                            <label class="form-check-label" for="is_active">
                                Service Active / Published
                            </label>
                        </div>
                        <div class="form-text">
                            <i class="bi bi-eye-fill"></i>
                            <span>When enabled, this service will be visible on your website</span>
                        </div>
                    </div>
...
<script>
    ...
    // ==========================================
    let selectedIcon = '{{ old("icon", $service->icon) }}';
        ...
        Object.keys(serviceIcons).forEach(category => {
            ...
            if (filteredIcons.length > 0) {
                ...
                filteredIcons.forEach(icon => {
                    const fullClass = `bi ${icon.class}`;
                    const isSelected = selectedIcon === fullClass;
                    html += `
                        <div class="icon-item ${isSelected ? 'selected' : ''}" data-icon="${fullClass}" data-name="${icon.name}">
    ...
    imageInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                newImagePreviewContainer.classList.add('active');
            }
    ...
    removeNewImageBtn.addEventListener('click', function() {
        imageInput.value = '';
        newImagePreview.src = '';
        newImagePreviewContainer.classList.remove('active');
    });
