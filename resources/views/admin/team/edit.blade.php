...
@section('header_title', 'Edit Member')

@push('styles')
<style>
    /* ============================================
       TEAM EDIT FORM - CORAL THEME
    ============================================ */
...
<div class="form-container">
    <div class="modern-form-card">
        ...
        <div class="modern-form-header">
            ...
            <p class="modern-form-subtitle">Update information for {{ $team->name }}</p>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="modern-form-group">
                        ...
                        <textarea
                            ...
                            name="bio"
                            rows="4"
                            placeholder="Write a brief description about this team member...">{{ old('bio', $team->bio) }}</textarea>
                        <div class="form-help-text">
                            <i class="bi bi-info-circle-fill"></i>
                ...
                <div class="form-section">
                    ...
                    <div class="current-photo-wrapper">
                        ...
                        <div class="current-photo-display">
                            ...
                            <div class="current-photo-info">
                                ...
                                <p class="current-photo-text">
                                    Upload a new photo below to replace this one
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modern-form-group">
                        <label for="photo" class="modern-label">
                            {{ $team->photo ? 'Change Photo' : 'Upload Photo' }}
                            <span class="label-hint">(optional)</span>
                        </label>
                        <input
                            type="file"
                        ...
                        <div class="photo-preview-wrapper" id="photoPreviewWrapper">
                            ...
                            <div class="photo-preview-display">
                                <div class="photo-preview">
                                    <img id="photoPreview" src="" alt="New Preview">
                                </div>
                                <div class="photo-preview-actions">
                                    <button type="button" class="btn-preview-action btn-preview-remove" id="removePhoto">
