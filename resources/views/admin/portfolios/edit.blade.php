...
<style>
    /* ============================================
       PORTFOLIO EDIT STYLES - CORAL THEME
    ============================================ */
        ...
        <div class="modern-card">
            <div class="modern-card-header">
                <h5>
                    ...
                    Edit Project
                    <span class="project-title-badge">
            ...
            <div class="modern-card-body">
                ...
                <div class="alert-info-custom">
                    ...
                    <div class="alert-info-custom-text">
                        <strong>Editing Mode:</strong> Update your project details below. Leave image field empty to keep the current image.
                    </div>
                </div>
                ...
                <form action="{{ route('admin.portfolios.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data" id="portfolioForm">
                        ...
                        <div class="category-grid">
                            <div class="category-option">
                                <input type="radio"
                                    ...
                                    {{ old('category', $portfolio->category) == 'Web Development' ? 'checked' : '' }}
                                    required>
                            ...
                            <div class="category-option">
                                <input type="radio"
                                    ...
                                    name="category"
                                    value="Mobile App"
                                    {{ old('category', $portfolio->category) == 'Mobile App' ? 'checked' : '' }}>
                            ...
                            <div class="category-option">
                                <input type="radio"
                                    ...
                                    name="category"
                                    value="IoT"
                                    {{ old('category', $portfolio->category) == 'IoT' ? 'checked' : '' }}>
                            ...
                            <div class="category-option">
                                <input type="radio"
                                    ...
                                    name="category"
                                    value="Design"
                                    {{ old('category', $portfolio->category) == 'Design' ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload-wrapper">
                            ...
                            <small class="form-text-modern">
                                <i class="bi bi-info-circle-fill"></i>
                                Leave empty to keep current image. Recommended: 1200x800px, Max: 2MB
                            </small>
                    ...
                    <div class="form-group">
                        ...
                        <div class="tag-input-wrapper">
                            ...
                            <input type="hidden" name="technologies" id="technologiesHidden" value="{{ old('technologies', $portfolio->technologies) }}">
                        </div>
                        <small class="form-text-modern">
                            <i class="bi bi-info-circle-fill"></i>
