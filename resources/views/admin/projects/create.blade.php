...
<style>
    /* ============================================
       PROJECT CREATE FORM - CORAL THEME
    ============================================ */
...
<div class="form-container">
    <div class="modern-form-card">
        ...
        <div class="modern-form-header">
            ...
            <p class="modern-form-subtitle">Fill in the information below to create a new project</p>
        </div>
        ...
        <form action="{{ route('admin.projects.store') }}" method="POST" id="projectForm">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                            ...
                            <div class="modern-form-group">
                                ...
                                <div class="input-with-icon">
                                    <select
                                        ...
                                        <option value="IoT" {{ old('project_type') == 'IoT' ? 'selected' : '' }}>IoT</option>
                        ...
                        <div class="col-md-3">
                            <div class="modern-form-group">
                                ...
                                <div class="badge-preview" id="priorityPreview">
                                    <div class="preview-label">Preview:</div>
                                    <span class="priority-badge medium" id="priorityBadge">
                    ...
                    <div class="modern-form-group">
                        ...
                        <textarea
                            ...
                            name="description"
                            rows="4"
                            placeholder="Describe the project scope, objectives, and requirements...">{{ old('description') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="modern-form-group">
                                ...
                                <div class="currency-display" id="currencyDisplay">
                                    <div class="currency-label">Formatted Amount:</div>
                        ...
                        <div class="col-md-4">
                            <div class="modern-form-group">
                                ...
                                <div class="badge-preview" id="statusPreview">
                                    <div class="preview-label">Preview:</div>
            ...
            <div class="modern-form-footer">
                <a href="{{ route('admin.projects.index') }}" class="btn-modern btn-modern-secondary">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        priceInput.form.appendChild(hiddenPriceInput);
        ...
        if (priceInput) {
            ...
            // Format on page load if there's old value
            if (priceInput.value) {
            ...
            // Before submit, ensure we're sending the numeric value
        ...
        if (prioritySelect) {
            prioritySelect.addEventListener('change', function() {
                ...
                priorityPreview.classList.add('active');
            });
        ...
        // Date validation: deadline should be after start date
