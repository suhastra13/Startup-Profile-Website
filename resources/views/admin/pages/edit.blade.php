    ...
    <div class="col-lg-10 col-xl-9">
        ...
        <div class="info-box">
            ...
            <p class="info-box-text">
                You're editing an existing page. Be careful when changing the slug/position as it may affect how the page is displayed on your website.
        ...
        <div class="page-info-badge">
            ...
            <span>Currently editing: <strong>{{ $page->title }}</strong></span>
        </div>
                ...
                <form action="{{ route('admin.pages.update', $page->id) }}" method="POST">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('slug') is-invalid @enderror"
                                ...
                                name="slug"
                                required>
                                <option value="" disabled>-- Select Page Position --</option>
                                <option value="about" {{ old('slug', $page->slug) == 'about' ? 'selected' : '' }}>
                                    About Us (Tentang Kami)
                                </option>
                                <option value="privacy" {{ old('slug', $page->slug) == 'privacy' ? 'selected' : '' }}>
                                    Privacy Policy
                                </option>
                                <option value="terms" {{ old('slug', $page->slug) == 'terms' ? 'selected' : '' }}>
                                    Terms of Service
                                </option>
                            </select>
                            @error('slug')
                            ...
                            <!-- Warning Box for Slug Change -->
                            <div class="warning-box">
                                <div class="warning-box-content">
                                    <i class="bi bi-exclamation-triangle-fill warning-box-icon"></i>
                                    <div class="warning-box-text">
                                        <strong>Warning:</strong> Changing the page position will move this content to a different URL.
                                        Make sure you select the correct position to avoid confusion on your website.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-text">
                            ...
                            <span>When enabled, this page will be visible to website visitors. Disable to hide it temporarily.</span>
                        </div>
                    </div>
